...
f1(x) = 4.0/pi * sin(x)
plot f1(x) lw 2 linetype 2 title "1st partial oscillation"

set output "images/order2.png"
f2(x) = 1.0/3.0*sin(3.0*x)
plot f2(x) lw 2 linetype 3 title "2nd partial oscillation"

set output "images/order3.png"
f3(x) = 1.0/5.0*sin(5.0*x)
plot f3(x) lw 2 linetype 4 title "3rd partial oscillation"

set output "images/order4.png"
f4(x) = 1.0/7.0*sin(7.0*x)
plot f4(x) lw 2 linetype 5 title "4th partial oscillation"

set output "images/order5.png"
f4(x) = 1.0/9.0*sin(9.0*x)
plot f4(x) lw 2 linetype 6 title "5th partial oscillation"
